  ...
  return (
    <Link
      ...
      className={cn(
        ...
        compact ? "aspect-[5/4] p-2" : "aspect-[4/3] p-3",
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-navy-950/55 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />

      <Icon
        className={cn(
          "relative text-navy-700 transition-all duration-400 group-hover:scale-90 group-hover:opacity-0",
          compact ? "text-[24px] md:text-[26px]" : "text-[38px] md:text-[44px]",
        )}
      />

      <span
        className={cn(
          "relative font-display font-semibold uppercase leading-tight text-navy-800 transition-colors duration-400 group-hover:text-white",
          compact
            ? "mt-1.5 text-[0.5625rem] tracking-[0.06em]"
            : "mt-2.5 text-[0.6875rem] tracking-[0.1em] md:text-[0.75rem]",
        )}
      >
        {category.name}
      </span>
