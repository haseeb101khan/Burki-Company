...
export const content: ContentSnapshot = {
  ...
  "partCategories": [
    ...
    },
    {
      ...
      "slug": "engine",
      "name": "Engine Parts",
      "description": "Gaskets, turbochargers, injectors, pumps and cooling components for diesel engines across the fleet.",
      "image": {
    ...
    },
    {
      ...
      "description": "Pumps, control valves, cylinders, seal kits and hoses that keep working circuits at pressure.",
      "image": {
        "src": "/images/part-hydraulic.jpg",
        "alt": "Hydraulic hoses and cylinder on a machine"
      },
      "order": 2
    },
    {
      ...
      "description": "Torque converters, clutch packs, shafts and gear sets for powershift and hydrostatic drivelines.",
      "image": {
        "src": "/images/part-transmission.jpg",
        "alt": "Metal drive gears in close-up"
      },
      "order": 3
    },
    {
    ...
    },
    {
      ...
      "slug": "undercarriage",
      "name": "Undercarriage",
      "description": "Track chains, rollers, idlers, sprockets and shoes for tracked excavators and dozers.",
      "image": {
        "src": "/images/part-undercarriage.jpg",
        "alt": "Heavy machinery track undercarriage"
      },
      "order": 5
    },
    {
      ...
      "slug": "electrical",
      "name": "Electrical",
      "description": "Alternators, starters, sensors, switchgear and wiring harnesses for machine control and starting systems.",
      "image": {
        "src": "/images/part-electrical.jpg",
        "alt": "Machine wiring and electrical components"
      },
      "order": 6
    },
    {
      ...
      "slug": "wear-parts",
      "name": "Wear Parts",
      "description": "Cutting edges, bucket teeth, adapters, side cutters and ground-engaging tools consumed by the job itself.",
      "image": {
        "src": "/images/part-wear-parts.jpg",
        "alt": "Excavator bucket with cutting teeth"
      },
      "order": 7
    }
  ],
  ...
  "parts": [
    {
      ...
      "categorySlug": "engine",
      "summary": "Complete multi-layer steel head gasket set with valve stem seals, sized for the WP6G engine family.",
      "image": {
        "src": "/images/part-engine.jpg",
        "alt": "Diesel engine assembly detail"
      },
    ...
    },
    {
      ...
      "categorySlug": "engine",
      "summary": "Balanced turbocharger assembly with wastegate actuator, supplied ready to fit with mounting gaskets.",
      "image": {
        "src": "/images/part-engine.jpg",
        "alt": "Diesel engine assembly detail"
      },
      "attributes": [
        {
          "label": "Type",
          "value": "Wastegated, water-cooled"
        },
        {
          "label": "Compressor wheel",
          "value": "Aluminium, 56 mm"
        },
        {
          "label": "Supplied with",
          "value": "Gasket set, oil feed line"
        }
      ],
      "compatibleEquipmentSlugs": [
        "lx-936",
    ...
    },
    {
      ...
      "summary": "Gear-type main pump for the working circuit, pressure-tested and shipped with a new mounting seal.",
      "image": {
        "src": "/images/part-hydraulic.jpg",
        "alt": "Hydraulic hoses and cylinder on a machine"
      },
    ...
    },
    {
      ...
      "categorySlug": "hydraulic",
      "summary": "Full seal and wiper kit for the loader lift cylinder, including rod seals, piston seals and dust wipers.",
      "image": {
        "src": "/images/part-hydraulic.jpg",
        "alt": "Hydraulic hoses and cylinder on a machine"
      },
    ...
    },
    {
      ...
      "summary": "Single-stage three-element torque converter, remanufactured to specification and dynamically balanced.",
      "image": {
        "src": "/images/part-transmission.jpg",
        "alt": "Metal drive gears in close-up"
      },
      "attributes": [
        {
          "label": "Type",
          "value": "Single-stage, three-element"
        },
        {
          "label": "Stall ratio",
          "value": "2.8:1"
    ...
    },
    {
      ...
      "categorySlug": "transmission",
      "summary": "Forged and heat-treated half shaft for the drive axle, machined to original spline dimensions.",
      "image": {
        "src": "/images/part-transmission.jpg",
        "alt": "Metal drive gears in close-up"
      },
    ...
    },
    {
      ...
      "summary": "Sealed and lubricated single-flange track roller with hardened tread, built for abrasive ground.",
      "image": {
        "src": "/images/part-undercarriage.jpg",
        "alt": "Heavy machinery track undercarriage"
      },
      "attributes": [
        {
          "label": "Type",
          "value": "Single flange, sealed"
        },
        {
          "label": "Tread hardness",
          "value": "HRC 52-58"
        },
        {
          "label": "Machine class",
    ...
    },
    {
      ...
      "summary": "Sealed 28 volt alternator with integrated regulator, specified for dust and vibration exposure.",
      "image": {
        "src": "/images/part-electrical.jpg",
        "alt": "Machine wiring and electrical components"
      },
    ...
    },
    {
      ...
      "summary": "Bolt-on boron steel cutting edge, drilled to standard pattern and reversible for double service life.",
      "image": {
        "src": "/images/part-wear-parts.jpg",
        "alt": "Excavator bucket with cutting teeth"
      },
    ...
    },
    {
      ...
      "categorySlug": "wear-parts",
      "summary": "Cast tooth points with retaining pins and rubber locks, supplied as a full set for one bucket.",
      "image": {
        "src": "/images/part-wear-parts.jpg",
        "alt": "Excavator bucket with cutting teeth"
      },
  ...
  "industries": [
    {
      ...
      "slug": "construction",
      "name": "Construction",
      "summary": "Building work from foundation to handover, where machine availability sets the programme.",
      "description": "General contracting puts mixed demands on a fleet: excavation and foundations early, material handling through the structure, then site clearance at the end. The machines that suit it are versatile rather than specialised, and easy to move between sites.",
      "image": {
        "src": "/images/ind-construction.jpg",
        "alt": "Construction site with tower cranes and structure under way"
      },
      "demands": [
        {
          "title": "Mixed duty",
          "description": "One machine covering excavation, loading and site logistics across a single contract."
        },
        {
          "title": "Site mobility",
          "description": "Transportable within legal limits so plant can follow the programme between sites."
        },
        {
          "title": "Uptime",
          "description": "Parts availability that keeps a critical-path machine from stopping the pour."
        }
      ],
    ...
    },
    {
      ...
      "slug": "infrastructure",
      "name": "Infrastructure",
      "summary": "Bridges, water schemes and public works measured in years rather than months.",
      "description": "Infrastructure contracts run long, and the plant on them is expected to run long with them. Machines are specified for sustained duty, deep excavation and heavy lifting, with service support planned around the contract rather than the individual breakdown.",
      "image": {
        "src": "/images/ind-infrastructure.jpg",
        "alt": "Large bridge construction with cranes"
      },
      "demands": [
        {
          "title": "Sustained duty",
          "description": "Cooling and filtration sized for months of continuous operation, not intermittent site work."
        },
        {
          "title": "Deep excavation",
          "description": "Reach and breakout for foundations, piers and cut-off walls."
        },
        {
          "title": "Planned maintenance",
          "description": "Scheduled service against contract milestones instead of reactive repair."
        }
      ],
      "recommendedCategorySlugs": [
        "excavators",
    ...
    },
    {
      ...
      "summary": "Formation, compaction and surfacing, where the whole fleet has to move at the pace of the paving train.",
      "description": "Road work is a sequence, and every machine in it is a dependency. Subgrade is cut and trimmed, base course is laid and compacted to density, aggregate is fed forward, and surfacing follows. A machine down at any stage stalls the ones behind it, so road contractors buy on availability and parts support as much as on specification. The fleet below covers formation through compaction, with the loading and haulage that keeps material moving to the front.",
      "image": {
        "src": "/images/ind-road-development.jpg",
        "alt": "Excavator and machinery working on a road construction project"
      },
      "demands": [
        {
          "title": "Level control",
          "description": "Fine grading to specified formation levels and camber, checked and held across long chainages."
        },
        {
          "title": "Compaction to density",
          "description": "Achieving and proving specified density on subgrade, sub-base and base course layers."
        },
        {
          "title": "Continuous material supply",
          "description": "Loading and haulage sized so the paving train never waits on aggregate."
        },
        {
          "title": "Linear site logistics",
          "description": "Machines that travel the alignment under their own power between working faces."
        }
      ],
      "recommendedCategorySlugs": [
        "rollers",
    ...
    },
    {
      ...
      "summary": "Extraction measured in tonnes per hour, on the hardest duty cycle a machine will see.",
      "description": "Quarry and mine work is the most punishing environment in the catalogue: abrasive material, long shifts, high ambient temperatures and haul roads that test structures and undercarriage alike. Specification here favours reinforced structures, heavy filtration and wear parts that can be replaced on site.",
      "image": {
        "src": "/images/ind-mining-quarrying.jpg",
        "alt": "Open pit quarry with haul roads"
      },
      "demands": [
        {
          "title": "Abrasion resistance",
          "description": "Ground-engaging tools and structures specified for high-density, abrasive material."
        },
        {
          "title": "High-volume loading",
          "description": "Bucket capacity matched to haul truck size to keep passes down."
        },
        {
          "title": "Field-replaceable wear parts",
          "description": "Cutting edges, teeth and undercarriage changed on site rather than in a workshop."
        }
      ],
      "recommendedCategorySlugs": [
        "wheel-loaders",
    ...
    },
    {
      ...
      "summary": "Ports, warehouses and industrial yards where throughput is the only measure that matters.",
      "description": "Material handling is repetitive, high-cycle work in constrained space. Machines are chosen for manoeuvrability, visibility and the ability to run shift after shift with predictable service intervals.",
      "image": {
        "src": "/images/ind-material-handling.jpg",
        "alt": "Container terminal with cranes and stacked containers"
      },
      "demands": [
        {
          "title": "Manoeuvrability",
          "description": "Working in aisles, between stacks and around fixed structures without repositioning."
        },
        {
          "title": "Cycle consistency",
          "description": "Predictable performance across full shifts rather than peak figures."
        },
        {
          "title": "Attachment flexibility",
          "description": "Forks, grapples and specialist tools changed quickly as the load changes."
        }
      ],
      "recommendedCategorySlugs": [
        "forklifts",
    ...
    },
    {
      ...
      "summary": "Plant construction, installation and expansion inside operating industrial sites.",
      "description": "Industrial work means operating inside someone else's live facility, often with restricted access and fixed shutdown windows. Machines are specified for controlled lifting, precise placement and the ability to work in confined space without disrupting production.",
      "image": {
        "src": "/images/ind-industrial-projects.jpg",
        "alt": "Industrial plant under construction"
      },
      "demands": [
        {
          "title": "Confined access",
          "description": "Compact machines that reach the work without dismantling the surrounding facility."
        },
        {
          "title": "Controlled placement",
          "description": "Precise, repeatable lifting and positioning for plant and structural elements."
        },
        {
          "title": "Shutdown windows",
          "description": "Reliability planned around fixed outage periods with no slack for breakdowns."
        }
      ],
      "recommendedCategorySlugs": [
        "cranes",
